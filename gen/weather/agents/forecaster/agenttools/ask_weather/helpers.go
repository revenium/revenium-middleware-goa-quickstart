...
import (
	ask_weatherspecs "quickstart/gen/weather/agents/forecaster/exports/ask_weather"
...
// Name is the DSL-declared name for the exported toolset "ask_weather".
const Name = "ask_weather"
...
const AgentID agent.Ident = "weather.forecaster"
...
const (
	// Ask is the canonical tool identifier for ask_weather.ask.
	...
	Ask tools.Ident = "ask_weather.ask"
)
...
type AskPayload = ask_weatherspecs.AskPayload
type AskResult = ask_weatherspecs.AskResult

var AskPayloadCodec = ask_weatherspecs.AskPayloadCodec
var AskResultCodec = ask_weatherspecs.AskResultCodec

// NewForecasterToolsetRegistration creates a toolset registration for the forecaster agent.
...
//
//	rt := runtime.New(...)
//	reg := NewForecasterToolsetRegistration(rt)
//	if err := rt.RegisterToolset(reg); err != nil {
//		// handle error
//	}
func NewForecasterToolsetRegistration(rt *runtime.Runtime) runtime.ToolsetRegistration {
	cfg := runtime.AgentToolConfig{
		AgentID:   AgentID,
		Name:      "ask_weather",
		TaskQueue: "weather_forecaster_ask_weather_tasks",
		Route: runtime.AgentRoute{
			ID:               AgentID,
			WorkflowName:     "weather.forecaster.workflow",
			DefaultTaskQueue: "weather_forecaster_workflow",
		},
...
// NewAskCall builds a planner.ToolRequest for the ask_weather.ask tool.
