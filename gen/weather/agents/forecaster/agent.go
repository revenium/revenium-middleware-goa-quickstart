...
// ForecasterAgent wraps the planner implementation for agent "forecaster".
type ForecasterAgent struct {
	Planner planner.Planner
}

// NewForecasterAgent validates the configuration and constructs a ForecasterAgent.
func NewForecasterAgent(cfg ForecasterAgentConfig) (*ForecasterAgent, error) {
	if err := cfg.Validate(); err != nil {
		return nil, err
	}
	return &ForecasterAgent{Planner: cfg.Planner}, nil
}
