...
// FinderAgent wraps the planner implementation for agent "finder".
type FinderAgent struct {
	Planner planner.Planner
}

// NewFinderAgent validates the configuration and constructs a FinderAgent.
func NewFinderAgent(cfg FinderAgentConfig) (*FinderAgent, error) {
	if err := cfg.Validate(); err != nil {
		return nil, err
	}
	return &FinderAgent{Planner: cfg.Planner}, nil
}
