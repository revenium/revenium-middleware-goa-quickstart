...
import (
	ask_hotelsspecs "quickstart/gen/hotels/agents/advisor/exports/ask_hotels"
...
// Name is the DSL-declared name for the exported toolset "ask_hotels".
const Name = "ask_hotels"
...
const (
	// Ask is the canonical tool identifier for ask_hotels.ask.
	...
	Ask tools.Ident = "ask_hotels.ask"
)
...
type AskPayload = ask_hotelsspecs.AskPayload
type AskResult = ask_hotelsspecs.AskResult

var AskPayloadCodec = ask_hotelsspecs.AskPayloadCodec
var AskResultCodec = ask_hotelsspecs.AskResultCodec

// NewAdvisorToolsetRegistration creates a toolset registration for the advisor agent.
...
//
//	rt := runtime.New(...)
//	reg := NewAdvisorToolsetRegistration(rt)
//	if err := rt.RegisterToolset(reg); err != nil {
//		// handle error
//	}
func NewAdvisorToolsetRegistration(rt *runtime.Runtime) runtime.ToolsetRegistration {
	cfg := runtime.AgentToolConfig{
		AgentID:   AgentID,
		Name:      "ask_hotels",
		TaskQueue: "hotels_advisor_ask_hotels_tasks",
...
// NewAskCall builds a planner.ToolRequest for the ask_hotels.ask tool.
