...
import (
	ask_travelspecs "quickstart/gen/travel/agents/planner/exports/ask_travel"
...
// Name is the DSL-declared name for the exported toolset "ask_travel".
const Name = "ask_travel"
...
const (
	// Ask is the canonical tool identifier for ask_travel.ask.
...
type AskPayload = ask_travelspecs.AskPayload
type AskResult = ask_travelspecs.AskResult

var AskPayloadCodec = ask_travelspecs.AskPayloadCodec
var AskResultCodec = ask_travelspecs.AskResultCodec

// NewPlannerToolsetRegistration creates a toolset registration for the planner agent.
...
//
//	rt := runtime.New(...)
//	reg := NewPlannerToolsetRegistration(rt)
//	if err := rt.RegisterToolset(reg); err != nil {
//		// handle error
//	}
func NewPlannerToolsetRegistration(rt *runtime.Runtime) runtime.ToolsetRegistration {
	cfg := runtime.AgentToolConfig{
		AgentID:   AgentID,
		Name:      "ask_travel",
		TaskQueue: "travel_planner_ask_travel_tasks",
		Route: runtime.AgentRoute{
			ID:               AgentID,
			WorkflowName:     "travel.planner.workflow",
			DefaultTaskQueue: "travel_planner_workflow",
		},
		PlanActivityName:    "travel.planner.plan",
		ResumeActivityName:  "travel.planner.resume",
...
// NewAskCall builds a planner.ToolRequest for the ask_travel.ask tool.
